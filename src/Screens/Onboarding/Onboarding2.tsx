...
const Onboarding2Screen = ({ navigation }: RouterProps) => {
  const onboard1 = Image.resolveAssetSource(require('./../../Assets/Images/On-BoardingIllustration2.png')).uri;
  const content1 = Image.resolveAssetSource(require('./../../Assets/Images/Content2.png')).uri;
  ...
  return (
    ...
    >
      <VStack space="md" alignItems="center">
        <AspectRatio w={450} ratio={1} right={0} left={0}>
      ...
      <HStack space={48} justifyContent={"space-between"}>
        ...
        <Button _text={{ color: "primary.50" }} borderRadius={10} bg="secondary.50" onPress={() => navigation.navigate('Onboarding3')} pl={10} pr={10} mb={5}
