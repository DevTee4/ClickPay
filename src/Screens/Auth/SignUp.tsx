                ...
                <VStack mt="5" space={8} w="100%" mx="auto">
                    <FormControl >
                        <Input borderRadius={10} p={3}
                            ...
                            bgColor={'grey.50'} borderColor={'grey.50'} placeholder="FULL NAME"
                            InputLeftElement=
                            {<VStack pl={4}>
                                <Icon as={<FontAwesomeIcon color={'#004852'} icon={faUser} />} size={4} />
                    ...
                    <Button onPress={() => navigation.navigate('SetPin')} p={4} bg="secondary.50" borderRadius={10} _text={{ color: "black", style: { fontWeight: 'bold' } }}>
                        SIGN UP
                    </Button>
                    <HStack justifyContent={"center"}>
                        ...
                        <Pressable onPress={() => navigation.navigate('SignIn')} >
                            <Text fontFamily="body" fontWeight="700" fontStyle="normal"> Log In</Text>
                        </Pressable>
                    </HStack>
                </VStack>
            </Box>
